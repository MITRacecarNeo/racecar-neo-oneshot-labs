...
def update():
    ...
    if rc.controller.get_trigger(rc.controller.Trigger._____) > 0.5:
        speed = _____
    elif rc.controller.get_trigger(rc.controller.Trigger._____) > 0.5:
        speed = -_____
    else:
        speed = 0
    ...
    # TODO Part 5: Implement a semi-autonomous safety-stop condition using the LIDAR sensor
